...
public class MainFragment extends Fragment {
    ...
    protected void loadImages(AsyncResponse delegate) {
    ...
    private class LoadImagesTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected List<String> doInBackground(Void... params) {
            ...
            Cursor cursor = getActivity().getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, columns, null, null, orderBy);
